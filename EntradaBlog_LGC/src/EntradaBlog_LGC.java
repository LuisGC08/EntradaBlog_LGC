	...
	public class EntradaBlog_LGC {
		...
		es negativo, lanza una excepción.
	        */
		public EntradaBlog_LGC(int id,String autor,String texto)throws IllegalArgumentException{
		...
		public static void main(String[] args) {
	                //Modificar.
			EntradaBlog_LGC e1=new EntradaBlog_LGC (-3,"ana","Últimas noticias, está disponible BixBy 2.0");
